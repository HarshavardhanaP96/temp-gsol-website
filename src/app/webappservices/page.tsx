     ...
     transition={{ duration: 0.8 }}  className="px-10 py-20 text-center">
        ...
        whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="max-w-sm bg-slate-500 shadow-md rounded-lg p-5 ">
            ...
            <h3 className="text-2xl font-semibold text-gray-100 mb-2 heading-2">Expert Team</h3>
            <p className="text-white para">
              Our team of experienced developers, designers, and project managers work together to deliver top-notch solutions tailored to your needs.
            </p>
          </div>
          <div className="max-w-sm bg-slate-500 shadow-md rounded-lg p-5">
            ...
            <h3 className="text-2xl font-semibold text-gray-100 mb-2 heading-2">Cutting-Edge Technology</h3>
            <p className="text-white para">
              We use the latest tools and technologies to build scalable, efficient, and secure applications that keep you ahead of the competition.
            </p>
          </div>
          <div className="max-w-sm bg-slate-500 shadow-md rounded-lg p-5">
            ...
            <h3 className="text-2xl font-semibold text-gray-100 mb-2 heading-2">Unmatched Support</h3>
            <p className="text-white para">
              Our dedicated support team is always ready and prepared to assist you, ensuring your projects run smoothly and efficiently with trust.
            </p>
          </div>
        </motion.div>
      </motion.div>
      ...
      <div className="px-10 mt-20 bg-gray-300">
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 mb-20">
          ...
          <motion.div 
           whileInView={{ opacity: 1, y: 0 }}
           initial={{ opacity: 0, y: 100 }}
           transition={{ duration: 0.8 }}className="text-center p-3 bg-white shadow-md rounded-lg w-40 h-w-40 flex flex-col justify-center items-center">
          ...
          <motion.div  whileInView={{ opacity: 1, y: 0 }}
           initial={{ opacity: 0, y: 100 }}
           transition={{ duration: 1 }}className="text-center p-3 bg-white shadow-md rounded-lg w-40 h-w-40 flex flex-col justify-center items-center">
