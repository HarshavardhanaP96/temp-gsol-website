...
const About = () => {
  return (
    <motion.div
      ...
      className="  flex flex-col mt-20 mb-20 px-10 heading-2"
    >
      ...
      <motion.p
        ...
        initial={{ opacity: 0, y: 100 }}
        transition={{ duration: 0.8 }}
        className=" text-black dark:text-gray-200 lg:text-2xl md:text-xl sm:text-lg para"
      >
      ...
      >
        ...
        youre a startup looking to make a mark or an established business
