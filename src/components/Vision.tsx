      ...
      >
        ...
        <div className="text-center lg:text-left lg:w-2/5">
          ...
          >
            ...
            website and app development, marketing services, IT solutions, and
            eco-friendly products such as biodegradable plates and kitchenware.
          </motion.p>
          <motion.p
            whileInView={{ opacity: 1, y: 0 }}
            initial={{ opacity: 0, y: 100 }}
          ...
          >
            ...
            technology to transform businesses and improve lives, and we strive
            to make a positive impact through our innovative solutions.
          </motion.p>
        </div>
      </motion.div>
      <motion.div
      ...
      >
        <div className="lg:text-left lg:w-2/5">
          ...
          >
            ...
            By integrating advanced technology with eco-friendly practices, we
            strive to lead the way in both industry and environmental
            stewardship.
          </motion.p>
          <motion.p
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            understand their goals and challenges. Through collaboration and
            innovation, we help them achieve their objectives and thrive in a
